        ...
        <div class="card">
            ...
            <form action="bayar.php" method="POST">
                ...
                <div class="mb-2">
                    ...
                    <input type="number" value="1237818281394" class="form-control" readonly> 
                </div>
                <div class="mb-2">
                ...
                <a href="histori.php" class="btn btn-outline" style="background-color: rgb(158, 74, 74); color: lavenderblush">Kembali ke data transaksi</a>
